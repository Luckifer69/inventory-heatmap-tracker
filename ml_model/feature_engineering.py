...
try:
    ...
    print("Warning: Could not import data_ingestion module. Individual testing may not work.")
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    required_columns = ['date', 'pincode', 'item', 'sales_quantity']
    ...
    for index, row in unique_combinations.iterrows():
        ...
        try:
            ...
            print(f"Error processing data for pincode {pincode}, item {item}: {e}")
            continue
    ...
    try:
        ...
        print(f"Error concatenating processed data: {e}")
        return pd.DataFrame()
...
if __name__ == "__main__":
    ...
    try:
        ...
        if not preprocessed_sales_df.empty:
            ...
            print("Preprocessed data is empty. Check the error messages above.")
    except Exception as e:
